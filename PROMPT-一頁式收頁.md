...
- **hero（最上面）和 footer（最下面）也不用做** —— 建置時會換成全站統一版型，
  做了也是白做。專心做中段內容：WHY 區位論證、WHAT 標的內容、規格表、現場相簿。
  hero 要用的標題、副標、四個 KPI 數字，收頁時由我寫進 cases.json。
  頁內請放幾張室內照，收頁時會從裡面挑一張當 hero 底圖（挑看不出建物外觀的）
